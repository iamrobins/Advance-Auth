    ...
    <div className="register-screen">
      <form onSubmit={handleRegister} className="register-screen__form">
        ...
        <div className="form-group">
          ...
          <input type="password" required id="confirmpassword" placeholder="Enter password again" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)}/>
        </div>

        <button type="subit" className="btn btn-primary">Register</button>
