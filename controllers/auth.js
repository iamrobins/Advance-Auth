...
exports.forgotPassword = async (req, res, next) => {
    ...
    try {
        ...
        if(!user) {
            return next(new ErrorResponse("Email could not be sent, email not registered", 404));
        }
        ...
        try {
            ...
            res.stats(200).json({success: true, data: "Email Sent"});
        } catch(err) {
...
exports.resetPassword = async (req, res, next) => {
    ...
    try {
        ...
        res.stats(201).json({success: true, data: "Password Reset Success"});
    } catch (err) {
        return next(err);
    }
